...
export const SITE = {
  ...
  description:
    'Практичен AI, ML и Python на български: тестове на нови модели, ръководства за начинаещи и AI за малкия бизнес.',
  ...
  author: {
    ...
    bio:
      'Ива Попова води курсове по Python, ML и AI от 2015 г., включително за корпоративни клиенти. ' +
      'Седем години (2005 - 2011) преподава AI и езици за програмиране в ТУ–София, където прави и докторски изследвания в областта на AI, семантично търсене, онтологии и NLP.',
  },
